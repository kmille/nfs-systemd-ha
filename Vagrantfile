...
$install_client = <<-EOL
    ...
    #mount 10.10.10.100:/opt/nfs_export /var/www/html/
    grep -q nfs /etc/fstab || echo '10.10.10.100:/opt/nfs_export    /var/www/html   nfs     _netdev,rw,soft,intr,tcp,nofail     0       0' >> /etc/fstab
EOL
...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "nfs-client", primary: true do |client|
    ...
    client.vm.network "private_network", ip: '10.10.10.101'
